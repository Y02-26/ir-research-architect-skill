...
**IR Research Architect** 是一个面向国际关系、国际政治、国家安全与区域国别研究等相关专业的 Agent Skill。它把《国际关系研究实用方法（第三版）》的方法论整理成可调用的研究设计知识库，帮你完整走过“选题 → 研究问题 → 文献综述设计 → 因果解释 → 假设 → 变量 → 操作化 → 假设检验 → 论文结构”。
...
```text
用户 ❯ 我已经有几篇文献和读书笔记，但不知道怎么组织综述

IR Research Architect ❯
先把你已有材料从“逐篇介绍”改成“解释类型地图”。
...
```text
用 IR Research Architect 根据我提供的文献笔记，整理一个文献综述矩阵。
```
...
| **文献综述设计** | 根据你提供的文献、摘要或读书笔记，整理争论地图、解释类型和研究缺口 |
| **因果解释** | 建立 X -> 机制 -> Y 的解释链，补充范围条件、反事实、可比性和竞争性解释 |
| **假设生成** | 把想法改写成有方向、有条件、有机制、有可观察含义且可被反驳的假设 |
...
IR Research Architect 把研究设计拆成九个环节：

1. 选题：把大主题压成具体现象、案例、时间和变化。
2. 研究问题：把研究兴趣改成能回答、能检验的问题。
3. 文献综述设计：根据已提供材料整理争论地图和研究缺口。
4. 因果解释：明确 X、Y、机制、范围条件、反事实、可比性和竞争性解释。
5. 假设：把解释改写成有方向、有条件、有机制、有可观察含义且可被反驳的假设。
6. 变量：区分自变量、因变量、中介变量、调节变量、混杂变量和控制变量。
7. 操作化：把抽象概念变成指标、数据来源和编码规则。
8. 假设检验：设计案例比较、过程追踪、定量检验或混合方法路径。
9. 论文结构：组织导论、文献、理论、方法、经验检验和结论。
...
- 这个 skill 不负责联网检索文献，也不会编造不存在的论文、作者或出处；文献综述相关输出应基于用户提供的文献、摘要、书目或读书笔记。
